...
#   G.add_node('E')
# #first type
#   G.add_edge('A','B',capacity_0=5000,capacity=1000,t_0=15,t_a=15,flow=0, distance_0=1)
#   G.add_edge('A','D',capacity_0=5000,capacity=1000,t_0=15,t_a=15,flow=0, distance_0=1)
#   G.add_edge('D','F',capacity_0=5000,capacity=1000,t_0=15,t_a=15,flow=0, distance_0=1)
#   G.add_edge('E','C',capacity_0=5000,capacity=1000,t_0=15,t_a=15,flow=0, distance_0=1)
#   G.add_edge('B','A',capacity_0=5000,capacity=1000,t_0=15,t_a=15,flow=0, distance_0=1)
#   G.add_edge('D','A',capacity_0=5000,capacity=1000,t_0=15,t_a=15,flow=0, distance_0=1)
#   G.add_edge('F','D',capacity_0=5000,capacity=1000,t_0=15,t_a=15,flow=0, distance_0=1)
#   G.add_edge('C','E',capacity_0=5000,capacity=1000,t_0=15,t_a=15,flow=0, distance_0=1)
# #second type
#   G.add_edge('B','D',capacity_0=5000,capacity=3000,t_0=20,t_a=20,flow=0, distance_0=1)
#   G.add_edge('D','B',capacity_0=5000,capacity=3000,t_0=20,t_a=20,flow=0, distance_0=1)
#   G.add_edge('A','E',capacity_0=5000,capacity=3000,t_0=20,t_a=20,flow=0, distance_0=1)
#   G.add_edge('E','A',capacity_0=5000,capacity=3000,t_0=20,t_a=20,flow=0, distance_0=1)
#   G.add_edge('E','F',capacity_0=5000,capacity=3000,t_0=20,t_a=20,flow=0, distance_0=1)
#   G.add_edge('F','E',capacity_0=5000,capacity=3000,t_0=20,t_a=20,flow=0, distance_0=1)
#   G.add_edge('F','C',capacity_0=5000,capacity=3000,t_0=20,t_a=20,flow=0, distance_0=1)
#   G.add_edge('C','F',capacity_0=5000,capacity=3000,t_0=20,t_a=20,flow=0, distance_0=1)
