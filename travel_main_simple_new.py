...
# with open( 'input/MedBridgeCap.txt','rb') as f: #UPDATED May 23, 2013
...
def pick_scenarios(lnsas, weights, multi=True):
  ...
  util.write_2dlist(time.strftime("%Y%m%d")+'_weights_10eps.txt', wout) #save the weights of the chosen scenarios
